...
<html>
	...
	<body  bgcolor = "#333333" width = 80%>
		<h1 style = "color:#D8D8D8; text-align: center; margin-top:50px"> WORD SENSE DISAMBIGUATION</h1>
		<div>
...
def main():
  ...
  print """
	  <form method="POST" action="posnltkv3.py">
					<table border = "0" align = "center" style="margin-top:50px; text-align:left" cellspacing="20">
						<tr>
							<td style = "color:#D8D8D8; font-size:20; ">Sentence:</td>
							<td>
								<input type = "text" name = "sent" width=300px > 
							</td>
						</tr>x
						<tr>
							<td style = "color:#D8D8D8; font-size:20;">Index:</td>
							<td>
								<input type = "text" name = "index" align="left"> 
							</td>
						</tr>
					</table>
						<input type="Submit" style="margin-left:155px; margin-top:30px;">
						<input type = "Reset" style="margin-left:50px; margin-top:30px;" >
				</form>
			</div>
    <p style = "margin-left:155px; font-size: 25px; color:#D8D8D8;">Sentence : %s</p>
    <p style = "margin-left:155px; font-size: 25px; color:#D8D8D8;">Index : %s</p>
		<p style = "margin-left:155px; font-size: 25px; color:#D8D8D8;">Best Sense : %s</p>
	  </body>
	  </html>
  """%(sent, index,output)
